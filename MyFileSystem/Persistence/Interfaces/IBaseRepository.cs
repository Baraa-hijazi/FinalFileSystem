...
namespace MyFileSystem.Persistence.Interfaces
{
    public interface IBaseRepository<T> where T : class
    {
        ...
        Task<PagedResultDto<T>> GetAllIncludedPagination(Expression<Func<T, bool>> predicate = null, int? pageIndex = 1, int? pageSize = 10, params Expression<Func<T, object>>[] includes);
